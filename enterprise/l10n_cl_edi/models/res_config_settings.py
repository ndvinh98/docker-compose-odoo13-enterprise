...
class ResConfigSettings(models.TransientModel):
    ...
    l10n_cl_country_code = fields.Char(related='company_id.country_id.code', string='Country Code')
    ...
    l10n_cl_dte_service_provider = fields.Selection([
        ...
        related='company_id.l10n_cl_dte_service_provider', readonly=False,
    ...
    l10n_cl_sii_regional_office = fields.Selection(
        L10N_CL_SII_REGIONAL_OFFICES_ITEMS, related='company_id.l10n_cl_sii_regional_office', readonly=False,
    ...
    l10n_cl_company_activity_ids = fields.Many2many(
    ...
    l10n_cl_sii_taxpayer_type = fields.Selection(
        related='company_id.l10n_cl_sii_taxpayer_type', index=True, readonly=False,
