...
class TestResCompany(TransactionCase):
    ...
    def test_get_digital_signature_valid(self):
        ...
        self.assertEquals(self.company_cl._get_digital_signature(), self.certificate)
    ...
    def test_get_digital_signature_user_not_valid_certificate(self):
        ...
        self.assertEquals(self.company_cl._get_digital_signature(user_id=user.id), self.certificate)
    ...
    def test_get_digital_signature_user_valid_certificate(self):
        ...
        self.assertEquals(self.company_cl._get_digital_signature(user_id=user.id), user_certificate)
